          ...
          <div className="home-content-wrapper">
            <div className="home-content">
              ...
              <div className="left-content">
                <p>As an enterprise product leader, I ship products that millions of people use in their daily work. At SAP SuccessFactors, I delivered AI-powered platform experiences to 26 million monthly users across 10K+ customers, achieving 12% satisfaction improvement and contributing to 31% NPS growth across the $2B business. I've orchestrated micro services platforms handling 1B+ annual views, implemented AI personalization at scale, and driven 100% feature adoption across large organizations.</p>
                <p>I focus on Human-centered AI experiences that drive sustainable business value. AI presents unprecedented promise to amplify human potential, but this can only happen if it's adopted and engaged. Technical capability is necessary but not sufficient for impact. At SAP, I built systematic adoption frameworks that reduced time-to-universal deployment by 50% while maintaining rigorous standards for accessibility, bias mitigation, and transparency.</p>
                <p>I'm committed to Enterprise AI product innovation where adoption and human experience are prioritized equally with technical innovation. I believe the next generation of enterprise software will be defined not by what AI can do, but by the business value that people create with it.</p>
